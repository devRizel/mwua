...
<div class="row">
  <div class="col-md-12">
    ...
    <td class="text-center">
    <form action="barrowedother1" method="get" style="display:inline;">
  ...
  <button type="submit" class="btn-custom" data-toggle="tooltip">
    ...
    <td class="text-center">
    <form action="barrowedother2" method="get" style="display:inline;">
    <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">

  ...
  <div class="col-md-7 col-md-offset-1">
    <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
      <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel-heading">
        <center><strong>Log Access IP Address</strong></center>
      </div>
      <div class="panel-body">
      <form method="POST" action="autolog2">
    <table style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="table table-bordered table-striped table-hover">
        ...
        ?>
            <tr>
                ...
                <td class="text-center"><?php echo remove_junk(ucfirst($room['access'])); ?></td>
                <td class="text-center"><?php echo (new DateTime($room['log_at']))->format('Y-m-d'); ?></td>
                <td class="text-center">
                    <div class="btn-group">
                        <a href="autolog2.php?id=<?php echo (int)$room['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">

...
function fetch_products() {
  ...
  $sql .= "AND p.barrow NOT LIKE '%Return%' "; // Exclude rows where "barrow" contains the word "Return"
...
<div class="row">
  ...
  <h1 class="text-center">Borrowed Computer Units</h1>
...
<div class="panel-body">
  ...
  <tr>
    ...
    <td class="text-center">
    <form action="barrowedcomputer1" method="get" style="display:inline;">
  ...
  <button type="submit" class="btn-custom" data-toggle="tooltip">
    ...
    <td class="text-center">
    <form action="barrowedcomputer2" method="get" style="display:inline;">
    <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">

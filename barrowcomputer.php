...
function fetch_products() {
    ...
    // Modify SQL query to include a WHERE clause that filters out products with media_id = 0 or NULL and checks that barrow is empty or NULL
    ...
    $sql .= "AND (p.barrow IS NULL OR p.barrow = '') "; // Filter out rows where barrow is not empty
...
<div class="row">
  ...
  <h1 class="text-center">All Computer Units To Barrowed</h1>
...
<div class="panel-body">
  ...
  <tr>
    ...
    <td class="text-center">
    <form action="barrowcomputerview" method="get" style="display:inline;">
  ...
  <button type="submit" class="btn-custom" data-toggle="tooltip">
    ...
    <td class="text-center">
    <form action="barrowcomputerbarrowedit" method="get" style="display:inline;">
    <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (successParam === 'true') {
        ...
        swal("", successMessage, "success")
            .then((value) => {
                window.location.href = 'barrowcomputer.php';
            });

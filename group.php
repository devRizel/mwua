  ...
  <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="col-md-12">
    ...
    <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel-heading clearfix">
      <strong>
        ...
        <span style="text-shadow: 2px 2px 2px rgba(0, 0, 0, 0.2);">Groups</span>
     </strong>
       <a href="add_group.php" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);" class="btn btn-info pull-right btn-sm"> Add New Group</a>
    </div>
     <div class="panel-body">
      <table style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="table table-bordered">
        <thead>
          <tr>

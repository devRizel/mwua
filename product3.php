...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <h1 class="text-center">IT Comlab 1 | Computer units</h1>
  ...
  <div class="search-container" style="display: inline-block; margin-left: 10px;">
    ...
    <td class="text-center">
    <form action="product3main" method="get" style="display:inline;">
    ...
    <td class="text-center">
    <form action="product3view" method="get" style="display:inline;">
  <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">
  <button type="submit" class="btn-custom" data-toggle="tooltip">
      <span class="glyphicon"></span> View
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="edit_product3.php?id=<?php echo (int)$product['id'];?>" class="btn btn-info btn-xs" title="Edit" data-toggle="tooltip">
                      <span class="glyphicon glyphicon-edit"></span>
                    </a>
                    <a href="delete_product3.php?id=<?php echo (int)$product['id'];?>" class="btn btn-danger btn-xs" title="Delete" data-toggle="tooltip">

...
if (isset($_POST['submit'])) {
  ...
  if ($photo->process_media()) {
      $session->msg('s', 'Device Photo has been uploaded.');
      redirect('media.php?success=true');
  } else {
              ...
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-btn">
                    <input  style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="file" name="file_upload" multiple="multiple" class="btn btn-primary btn-file"/>
                 </span>

                 <button  style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="submit" name="submit" class="btn btn-default">Upload</button>
               </div>
              </div>
             </form>
            </div>
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <td class="text-center">
                <a href="edit_media.php?id=<?php echo (int) $media_file['id'];?>" class="btn btn-info btn-xs"  title="Edit">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (successParam === 'true') {
        if (urlParams.get('delete_photo')) {
            ...
            successMessage = "Successfully Updated Device Photos.";
        } else {
            successMessage = "Device Photo has been uploaded.";
        }
    ...
    document.querySelectorAll('.btn-danger').forEach(button => {
        button.addEventListener('click', function(event) {
            ...
            swal({
              title: "Are you sure?",
              text: "Once deleted, this device photo cannot be recovered!",
              icon: "warning",
              ...
              dangerMode: true,
                ...
                if (willDelete) {
                    ...
                    swal("Device Photo deleted successfully.", {
                        icon: "success",
                    }).then(() => {

...
$all_photo = array_filter($all_photo, function($photo) {
    return $photo['file_name'] == 'Computer.jpg';
  });
    ...
    <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
      <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel-heading">
        <strong>
          ...
          <span>Add Computer Units</span>
        </strong>
      </div>
      <div class="panel-body">
        <form method="post" action="editaddproduct?id=<?php echo (int)$product['id'] ?>">
        <div class="form-group col-md-8 col-md-offset-2">
            ...
            <select style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" class="form-control" name="Room-Title">
              ...
              <?php foreach ($all_room as $room): ?>
                <option value="<?php echo htmlspecialchars(remove_junk($room['name'])); ?>" <?php if (remove_junk($room['name']) === $form_data['Room-Title']) echo 'selected="selected"'; ?>>
          ...
          <div class="form-group">
            <div class="row">
                ...
                <select style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" class="form-control" name="Device-Photo">
                  ...
                  <?php foreach ($all_photo as $photo): ?>
                    <option value="<?php echo (int)$photo['id']; ?>" 
                         <?php 
                            if ($photo['file_name'] == 'Computer.jpg' || $form_data['Device-Photo'] == $photo['id']) echo "selected";?>>
                          <?php echo htmlspecialchars($photo['file_name']); ?>
                    </option>
                  <?php endforeach; ?>
                </select>
              </div>
              <div class="col-md-4">
                     ...
                     <input id="donate" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="donate" value="<?php echo htmlspecialchars($form_data['donate']);?>">
                 </div>
            </div>
          </div>
          ...
          <div class="form-group">
               ...
               <div class="col-md-4">
                     ...
                     <input id="h" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="recievedby" value="<?php echo htmlspecialchars($form_data['recievedby']);?>">
                 </div>
               <div class="col-md-4">
                     <label for="Device-Photo">Date Received</label>
                     <input  style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control datepicker" name="dreceived" required readonly value="<?php echo htmlspecialchars($form_data['dreceived']);?>">
                  </div>
                 <div class="col-md-4">
                     <label for="Device-Photo">Monitor</label>
                     <input id="e" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="monitor" value="<?php echo htmlspecialchars($form_data['monitor']);?>">
                 </div>
               </div>
          </div>
          ...
          <div class="form-group">
               ...
               <div class="col-md-4">
                     ...
                     <input id="r" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="Keyboard" value="<?php echo htmlspecialchars($form_data['Keyboard']);?>">
                  </div>
                 <div class="col-md-4">
                     <label for="Device-Photo">Mouse</label>
                     <input id="t" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="mouse" value="<?php echo htmlspecialchars($form_data['mouse']);?>">
                 </div>
                 <div class="col-md-4">
                     <label for="Device-Photo">VGA|HDMI</label>
                     <input id="w" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="v1" value="<?php echo htmlspecialchars($form_data['v1']);?>">
                  </div>
               </div>
          </div>
          ...
          <div class="form-group">
               ...
               <div class="col-md-4">
                     ...
                     <input id="y" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="p1" value="<?php echo htmlspecialchars($form_data['p1']);?>">
                 </div>
                 <div class="col-md-4">
                     <label for="Device-Photo">Power Chord 2</label>
                     <input id="u" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="p2" value="<?php echo htmlspecialchars($form_data['p2']);?>">
                  </div>
                  <div class="col-md-4">
                     <label for="Device-Photo">Power Supply|AVR</label>
                     <input id="i" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="power1" value="<?php echo htmlspecialchars($form_data['power1']);?>">
                 </div>
               </div>
          </div>
          ...
          <div class="form-group">
               ...
               <div class="col-md-4">
                     ...
                     <input id="o" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="system" value="<?php echo htmlspecialchars($form_data['system']);?>">
                  </div>
                 <div class="col-md-4">
                     <label for="Device-Photo">Motherboard Model</label>
                     <input id="p" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="mother" value="<?php echo htmlspecialchars($form_data['mother']);?>">
                 </div>
                 <div class="col-md-4">
                     <label for="Device-Photo">CPU|Processesor</label>
                     <input id="a" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="cpu" value="<?php echo htmlspecialchars($form_data['cpu']);?>">
                  </div>
               </div>
          </div>
          ...
          <div class="form-group">
               ...
               <div class="col-md-4">
                     ...
                     <input id="s" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="ram" value="<?php echo htmlspecialchars($form_data['ram']);?>">
                 </div>
                 <div class="col-md-4">
                     <label for="Device-Photo">Power Supply 2</label>
                     <input id="d" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="power2" value="<?php echo htmlspecialchars($form_data['power2']);?>">
                  </div>
                  <div class="col-md-4">
                     <label for="Device-Photo">Video Card|GPU</label>
                     <input id="f" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="video" value="<?php echo htmlspecialchars($form_data['video']);?>">
                 </div>
               </div>
          </div>
          ...
          <div class="form-group">
               ...
               <div class="col-md-8 col-md-offset-2">
                     ...
                     <input id="g" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="h" value="<?php echo htmlspecialchars($form_data['h']);?>">
                     </div>
                  </div>
            </div>
               </div>
          ...
          <center><div class="form-group">
            ...
            <a style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" href="addproducts.php" class="btn btn-danger">Cancel</a>
          </div></center>
        </form>
      </div>
    </div>
...
<script>
    ...
    detectXSS(donateInput, 'Donated By');
    detectXSS(wInput, 'VGA|HDMI');
    detectXSS(eInput, 'Monitor');
    detectXSS(rInput, 'Keyboard');
    detectXSS(tInput, 'Mouse');

  ...
  <div class="col-md-offset-2 col-md-8">
    <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="post" action="edit_product?id=<?php echo (int)$product['id'] ?>">
          ...
          <div class="form-group">
               <div class="row">
                 <div class="col-md-6">
                     ...
                     <input id="donate" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="donate" value="<?php echo remove_junk($product['donate']);?>">
                 </div>
                 <div class="col-md-6">
          ...
          <div class="form-group">
               <div class="row">
                 <div class="col-md-6">
                     ...
                     <input id="e" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="monitor" value="<?php echo remove_junk($product['monitor']);?>">
                 </div>
                 <div class="col-md-6">
                     <label for="Device-Photo">Keyboard</label>
                     <input id="r" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="Keyboard" value="<?php echo remove_junk($product['Keyboard']);?>">
                  </div>
               </div>
          </div>
          ...
          <div class="form-group">
               <div class="row">
                 <div class="col-md-6">
                     ...
                     <input id="t" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="mouse" value="<?php echo remove_junk($product['mouse']);?>">
                 </div>
                 <div class="col-md-6">
                     <label for="Device-Photo">VGA|HDMI</label>
                     <input id="w" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);" type="text" class="form-control" name="v1" value="<?php echo remove_junk($product['v1']);?>">
                  </div>
               </div>
          </div>

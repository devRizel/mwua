...
?>
<center><h1>Computer Unit View</h1></center>
<div class="panel-body">
    <form method="post" action="overallviewcomputer?id=<?php echo (int)$product['id'] ?>">
        <div class="container">
...
<div class="panel-body">
    ...
    <input style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4); pointer-events: none;" type="text" class="form-control datepicker" name="dreceived" required readonly value="<?php echo remove_junk($product['dreceived']);?>">
          ...
          <center><div class="form-group">
            <a style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" href="computer.php" class="btn btn-danger">Back</a>
          </div></center>
        </form>
      </div>

...
if (isset($_POST['submit'])) {
  ...
  if ($photo->process_computer()) {
      $session->msg('s', 'Barcode Photo has been uploaded.');
      redirect('bar1.php?success=true'); // Redirect with success parameter
  } else {
...
<?php endif; ?>
<!--END-->
<center><h1>Add Barcode|Computer</h1></center>
        ...
        <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
          <div  style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel-heading clearfix">
            ...
            <div class="pull-right">
              <form class="form-inline" action="bar1" method="POST" enctype="multipart/form-data">
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <tbody>
                <?php foreach ($computer_files as $computer_file): ?>
                <tr class="list-inline">
                 <td class="text-center"><?php echo count_id();?></td>
                  <td class="text-center">
                      <img src="uploads/products/<?php echo $computer_file['file_name'];?>" class="img-thumbnail" />
                  </td>
                <td class="text-center">
                  <?php echo $computer_file['file_name'];?>
                </td>
                <td class="text-center">
                  <?php echo $computer_file['file_type'];?>
                </td>
                <td class="text-center">
                <a href="edit_bar1.php?id=<?php echo (int) $computer_file['id'];?>" class="btn btn-info btn-xs"  title="Edit">
                    <span class="glyphicon glyphicon-edit"></span>
                  </a>
                  <a href="delete_bar1.php?id=<?php echo (int) $computer_file['id'];?>" class="btn btn-danger btn-xs"  title="Delete">

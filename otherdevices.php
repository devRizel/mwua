  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <h1 class="text-center">Peripheral devices to be repaired </h1>
          ...
          <table class="table table-bordered" id="product-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
    <form action="otherdevicesmain" method="get" style="display:inline;">
    ...
    <td class="text-center">
    <form action="otherdevicesview" method="get" style="display:inline;">
  <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    categorySelect.addEventListener('change', function() {
        ...
        rows.forEach(row => {
            const categoryCell = row.querySelector('td:nth-child(4)'); // Adjusted index for Category
    ...
    searchBar.addEventListener('input', function() {
        ...
        rows.forEach(row => {
            const serialCell = row.querySelector('td:nth-child(5)'); // Adjusted index for Serial Num.
            const serialNum = serialCell ? serialCell.textContent.toLowerCase() : '';

            if (serialNum.includes(searchTerm)) {
                row.style.display = '';
            } else {
                row.style.display = 'none';
            }

...
<?php endif; ?>
<!--END-->
<center><h1>Add Peripheral Device Barcode</h1></center>
     <div class="row">
        ...
        <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
          <div  style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel-heading clearfix">
            ...
            <div class="pull-right">
              <form class="form-inline" action="bar16" method="POST" enctype="multipart/form-data">
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <td class="text-center">
                <a href="edit_bar16.php?id=<?php echo (int) $other_images_file['id'];?>" class="btn btn-info btn-xs"  title="Edit">
                    <span class="glyphicon glyphicon-edit"></span>
                  </a>
                  <a href="delete_bar16.php?id=<?php echo (int) $other_images_file['id'];?>" class="btn btn-danger btn-xs"  title="Delete">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (successParam === 'true') {
        if (urlParams.get('delete_photo')) {
            ...
            successMessage = "Successfully Updated Peripheral Barcode.";
        } else {
            successMessage = "Peripheral Barcode has been uploaded.";
        }

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: sms_npass.php?access=allowed");
    exit();
    } else {
...
<body>
    ...
    <div class="text-center">
        ...
        <input class="input100" id="otp" type="text" name="otp" placeholder="Enter your OTP" maxlength="6" pattern="[0-9]{6}" required>
      ...
      <div class="container-login100-form-btn">
        <button class="login100-form-btn" name="submit" type="submit"> Verify OTP</button>
      </div>

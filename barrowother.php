...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <h1 class="text-center">Peripheral Devices To Barrowed</h1>
    ...
    <td class="text-center">
    <form action="barrowotherview" method="get" style="display:inline;">
  ...
  <button type="submit" class="btn-custom" data-toggle="tooltip">
    ...
    <td class="text-center">
    <form action="barrowotherbarrowedit" method="get" style="display:inline;">
    <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">

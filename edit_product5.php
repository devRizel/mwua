...
<link rel="icon" type="image/x-icon" href="uploads/users/rizel.png"><?php
...
if ($selected_date > $today) {
    ...
    if (empty($errors)) {
        ...
        if ($result && $db->affected_rows() === 1) {
            redirect('product5.php?success=true&update_success=true', false);
        } else {
            $session->msg('d', 'Failed to update Computer.');
            redirect('edit_product5.php?id=' . (int)$product['id'], false);
        }
    }
}
  ...
  <div class="col-md-offset-2 col-md-8">
    <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="post" action="edit_product5?id=<?php echo (int)$product['id'] ?>">
          ...
          <center><div class="form-group">
            ...
            <a style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" href="product5.php" class="btn btn-danger">Cancel</a>
          </div></center>
        </form>
      </div>
    </div>

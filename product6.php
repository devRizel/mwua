...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <h1 class="text-center">IT Comlab 4 | Computer units</h1>
  ...
  <div class="search-container" style="display: inline-block; margin-left: 10px;">
    ...
    <td class="text-center">
    <form action="product6main" method="get" style="display:inline;">
    ...
    <td class="text-center">
    <form action="product6view" method="get" style="display:inline;">
  <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">

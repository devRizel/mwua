...
if (isset($_POST['submit'])) {
    ...
    redirect('barrowedcomputerreturn.php?success=true&update_success=true', false);
}
...
<div class="panel-body">
    <form method="post" action="barrowedcomputerreturn1?id=<?php echo (int)$product['id'] ?>">
        <div class="container">
...
<div class="panel-body">
    ...
    <input style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4); pointer-events: none;" type="text" class="form-control datepicker" name="dreceived" required readonly value="<?php echo remove_junk($product['dreceived']);?>">
          ...
          <center><div class="form-group">
            <a style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" href="barrowedcomputerreturn.php" class="btn btn-danger">Back</a>
          </div></center>
        </form>
      </div>
